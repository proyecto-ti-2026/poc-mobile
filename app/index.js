...
// Cliente OAuth tipo "Aplicación web" en Google Cloud Console.
// Redirect para Expo Go: debe coincidir exactamente con la URI autorizada allí.
const GOOGLE_WEB_CLIENT_ID =
  "810288152034-bsspraoe3u7ee4smimgq161n0bd7kisg.apps.googleusercontent.com";
const REDIRECT_URI = "https://auth.expo.io/@nicodiazdiez/mobile";
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Accedé a tu cuenta para continuar con tus pedidos.
        </Text>
